...
export default function Register() {
  return (
    <div className="flex flex-col gap-y-5 justify-center items-center min-h-screen bg-white">
      ...
      <div className="w-full max-w-md p-6 space-y-6 bg-gray-50 shadow">
        ...
        <form className="space-y-6">
          ...
          <div className="mt-5">
            <button
              type="submit"
              className="w-full py-2 px-4 bg-purple-500 hover:bg-black text-white hover:font-semibold transition-transform duration-200 transform hover:scale-105"
            >
              Register Now
            </button>
          </div>
